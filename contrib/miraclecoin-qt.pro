...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/miraclecoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/miraclecoin-cli.cpp \
           src/miraclecoin-tx.cpp \
           src/miraclecoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/miraclecoin.qrc src/qt/miraclecoin_locale.qrc

TRANSLATIONS += src/qt/locale/miraclecoin_bg.ts \
                src/qt/locale/miraclecoin_de.ts \
                src/qt/locale/miraclecoin_en.ts \
                src/qt/locale/miraclecoin_es.ts \
                src/qt/locale/miraclecoin_fi.ts \
                src/qt/locale/miraclecoin_fr.ts \
                src/qt/locale/miraclecoin_it.ts \
                src/qt/locale/miraclecoin_ja.ts \
                src/qt/locale/miraclecoin_pl.ts \
                src/qt/locale/miraclecoin_pt.ts \
                src/qt/locale/miraclecoin_ru.ts \
                src/qt/locale/miraclecoin_sk.ts \
                src/qt/locale/miraclecoin_sv.ts \
                src/qt/locale/miraclecoin_vi.ts \
                src/qt/locale/miraclecoin_zh_CN.ts \
                src/qt/locale/miraclecoin_zh_TW.ts
