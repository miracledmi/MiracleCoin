...
from test_framework.miraclecoin_node import MiracleCoinTestNode
...
class MiracleCoin_ColdStakingTest(MiracleCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(MiracleCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 MRC from the pot)
...
if __name__ == '__main__':
    MiracleCoin_ColdStakingTest().main()
