Contributing to MiracleCoin
============================

The MiracleCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/miraclecoin-project/miraclecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MiracleCoin project, and is not to be
confused with overall MiracleCoin Network Protocol consensus changes.

Whether a pull request is merged into MiracleCoin rests with the project merge
...
Patches that change MiracleCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the MiracleCoin consensus, it must have been
...
The project leader is the release manager for each MiracleCoin release.
