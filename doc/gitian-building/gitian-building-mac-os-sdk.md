...
The script [extract-osx-sdk.sh](https://github.com/miraclecoin-project/miraclecoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
miraclecoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/miraclecoin-project/miraclecoin/blob/master/doc/README_osx.md) for troubleshooting tips.
