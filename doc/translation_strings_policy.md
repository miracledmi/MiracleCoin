...
This document provides guidelines for internationalization of the MiracleCoin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to MiracleCoin network</source>
        <translation>
            <numerusform>%n active connection to MiracleCoin network</numerusform>
            <numerusform>%n active connections to MiracleCoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `miraclecoin_en.ts` remains unchanged.
