...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MiracleCoin miraclecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  miraclecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded miraclecoin transaction") + "\n" +
                               "  miraclecoin-tx [options] -create [commands]   " + _("Create hex-encoded miraclecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded miraclecoin transaction
