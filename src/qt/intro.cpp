...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MiracleCoin"),
     ...
     * override -datadir in the miraclecoin.conf file in the default data directory
     * (to be consistent with miraclecoind behavior)
     */
