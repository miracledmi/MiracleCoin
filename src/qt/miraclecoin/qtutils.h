...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MiracleCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, MiracleCoinGUI* gui, double posX = 3);
