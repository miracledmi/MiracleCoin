...
#include "qt/miraclecoin/forms/ui_send.h"
#include "qt/miraclecoin/addnewcontactdialog.h"
#include "qt/miraclecoin/qtutils.h"
#include "qt/miraclecoin/sendchangeaddressdialog.h"
#include "qt/miraclecoin/optionbutton.h"
#include "qt/miraclecoin/sendconfirmdialog.h"
#include "qt/miraclecoin/myaddressrow.h"
#include "qt/miraclecoin/guitransactionsutils.h"
...
SendWidget::SendWidget(MiracleCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-mrc");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination mrcAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(mrcAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(mrcAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
