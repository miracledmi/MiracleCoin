...
#include "qt/miraclecoin/settings/settingsnetworkwidget.h"
#include "qt/miraclecoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/miraclecoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MiracleCoinGUI* _window, QWidget *parent) :
