...
#include "qt/miraclecoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/miraclecoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MiracleCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MiracleCoin RPC console.") + "<br>" +
