...
#include "qt/miraclecoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/miraclecoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MiracleCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MiracleCoinGUI::handleRestart()
