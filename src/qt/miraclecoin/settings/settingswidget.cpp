...
#include "qt/miraclecoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MiracleCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &MiracleCoinGUI::openFAQ);
