...
#include "qt/miraclecoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/miraclecoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MiracleCoinGUI* _window, QWidget *parent) :
