...
#include "qt/miraclecoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(MiracleCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("MiracleCoin_tx_csv_export(*.csv)") : tr("MiracleCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
