...
#include "qt/miraclecoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/miraclecoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(MiracleCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableMRC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableMRC,
    ...
    connect(ui->pushButton_UnspendableMRC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableMRC);});
    ...
    if (parent)
        connect(parent, &MiracleCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
