...
#include "qt/miraclecoin/forms/ui_addresseswidget.h"
#include "qt/miraclecoin/addresslabelrow.h"
#include "qt/miraclecoin/addnewaddressdialog.h"
#include "qt/miraclecoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(MiracleCoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination mrcAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(mrcAdd, label.toUtf8().constData(),
