...
#include "qt/miraclecoin/sendcustomfeedialog.h"
#include "qt/miraclecoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MiracleCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MiracleCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
