...
/* MiracleCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MiracleCoin"
#define QAPP_ORG_DOMAIN "miraclecoin.org"
#define QAPP_APP_NAME_DEFAULT "MiracleCoin-Qt"
#define QAPP_APP_NAME_TESTNET "MiracleCoin-Qt-testnet"
