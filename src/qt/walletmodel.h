...
#ifndef MiracleCoin_QT_WALLETMODEL_H
#define MiracleCoin_QT_WALLETMODEL_H
...
/** Interface to MiracleCoin wallet from Qt view code. */
...
#endif // MiracleCoin_QT_WALLETMODEL_H
