...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MiracleCoinGUI* window = static_cast<MiracleCoinGUI*>(parentWidget());
...
{
    MiracleCoinGUI* gui = static_cast<MiracleCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<MiracleCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MiracleCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MRCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
