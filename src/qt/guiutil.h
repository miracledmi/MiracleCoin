...
/** Utility functions used by the MiracleCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MiracleCoin addresses in monospace font
...
// Parse "miraclecoin:" URI into recipient object, return true on successful parsing
